...
function AllProducts() {
  ...
  return (
    <div className="pt-70 bg-gradient-to-b from-green-100 e min-h-screen">
      <Head>
        <title>All Products</title>
      </Head>
      <h1 className="text-4xl font-bold text-green-950 mb-8 pl-8 max-w-xl">
        ALL PRODUCTS
      </h1>
      <div className="relative w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="grid grid-cols-4 gap-6 p-4">
          {items.slice(startIndex, startIndex + 4).map((item) => (
            <div
              key={item.product_id}
              className="w-80 min-h-[400px] p-4 border rounded-lg shadow-xl flex flex-col items-center text-center bg-white hover:shadow-2xl transition-transform transform hover:scale-105"
            >
