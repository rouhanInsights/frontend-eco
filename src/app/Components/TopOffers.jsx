...
function TopOffers() {
  ...
  return (
    <div className="pt-20 bg-gradient-to-b from-green-100  to-white min-h-screen">
      <Head>
        <title>All Products</title>
      </Head>
      <h1 className="text-4xl font-bold text-green-950 mb-8 pl-8 max-w-xl">TOP OFFERS</h1>
